...
// ----- 1. Map constants -----
const JAMAICA_CENTER = { lat: 18.204333965681116, lng: -77.37938278401592 };
const DEFAULT_ZOOM = 9;

// Parish centre coordinates for "zoom to parish"
// Names must EXACTLY match churchesData[i].parish
const parishCenters = {
  "Clarendon":     { lat: 17.9,  lng: -77.25 },
  "Hanover":       { lat: 18.4,  lng: -78.17 },
  "Kingston":      { lat: 17.97, lng: -76.79 },
  "Manchester":    { lat: 18.05, lng: -77.5  },
  "Portland":      { lat: 18.15, lng: -76.55 },
  "St. Andrew":    { lat: 18.0,  lng: -76.8  },
  "St. Ann":       { lat: 18.4,  lng: -77.2  },
  "St. Catherine": { lat: 17.95, lng: -76.95 },
  "St. Elizabeth": { lat: 18.05, lng: -77.75 },
  "St. James":     { lat: 18.45, lng: -77.9  },
  "St. Mary":      { lat: 18.3,  lng: -76.9  },
  "St. Thomas":    { lat: 17.9,  lng: -76.5  },
...
function setSelectedChurch(church, marker, options = {}) {
  ...
  if (selectedMarker) {
    const prevColor =
      parishColors[selectedMarker._parishName] || FALLBACK_MARKER_COLOR;
  ...
  if (marker) {
    ...
    marker.setIcon({
      path: google.maps.SymbolPath.BACKWARD_CLOSED_ARROW,
      scale: 7,
      fillColor: parishColors[church.parish] || FALLBACK_MARKER_COLOR,
      fillOpacity: 1,
      strokeColor: "#222222",
      strokeWeight: 1
    });
